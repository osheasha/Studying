...
public class Assignment1CircleTest {
    ...
    @Test
    public void radius_negative_to_zero() {
        Circle circle = new Circle(onePoint, -5);
        assertThat("Radius should default to zero if a negative radius is provided", circle.getRadius(), equalTo(0.0));
    }
    ...
    public void equals_other_Circle_succesful() {
        assertTrue("Different circles with same attributes should be equal", one.equals((Object) same_one));
    }
